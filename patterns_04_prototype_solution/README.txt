...
 
 The problem is that we have complicated (possible, but not very practical) create burgers types such as
...
 
		Burger royalWithoutOnion = new BurgerFactory ()
				...
				.create ();
 
 Modify the BurgerFactory class to make it easy to place this order. It would be something
