...
In the test you will find the instructions: create a new implementation called InternationalPackageProcessing 
that accepts all requests except those going to Mordor (more details in the test)
